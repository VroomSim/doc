...
function NESPiCase() {
    ...
    #Set GPIOs
    [[ -z $1 || $1 == "-1" ]] && GPIO_resetswitch=27 || GPIO_resetswitch=$1
    [[ -z $2 || $2 == "-1" ]] && GPIO_powerswitch=25 || GPIO_powerswitch=$2
    [[ -z $3 || $3 == "-1" ]] && GPIO_poweronctrl=26 || GPIO_poweronctrl=$3
...
function NESPiPlus() {
    ...
    [[ -z $2 || $2 == "-1" ]] && GPIO_powerswitch=25 || GPIO_powerswitch=$2
    [[ -z $3 || $3 == "-1" ]] && GPIO_poweronctrl=26 || GPIO_poweronctrl=$3
    [[ -z $4 || $4 == "-1" ]] && GPIO_lediodectrl=24 || GPIO_lediodectrl=$4
...
function GenericButton() {
    ...
    # Set GPIO
    [[ -z $1 || $1 == "-1" ]] && GPIO_powerswitch=25 || GPIO_powerswitch=$1
...
function Mausberry() {
    ...
    [[ -z $2 || $2 == "-1" ]] && GPIO_poweronctrl=26 || GPIO_poweronctrl=$2
